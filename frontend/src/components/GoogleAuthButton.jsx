...
export default function GoogleAuthButton({ text = "Continue with Google" }) {
    ...
    return (
        <button
            ...
            type="button"
            className="w-full flex items-center justify-center gap-3 px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600 transition-colors shadow-sm group"
        >
            {/* Google Logo SVG */}
            <svg
                className="w-5 h-5"
