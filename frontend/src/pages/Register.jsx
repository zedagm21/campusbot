      ...
      <div className="w-full max-w-5xl h-[85vh] max-h-[650px] flex rounded-3xl shadow-2xl overflow-hidden bg-white dark:bg-gray-800">
        ...
        <div className="flex-1 p-6 lg:p-8 flex flex-col justify-center overflow-y-auto">
          ...
          <div className="text-center mb-5">
            ...
            <h2 className="text-2xl lg:text-3xl font-bold text-gray-800 dark:text-white mt-2">Create Account</h2>
          ...
          <form className="space-y-3.5" onSubmit={handleRegister}>
            ...
            {message && (
              <div className={`text-sm text-center p-2.5 rounded-lg ${message.startsWith("✅") ? "bg-green-50 dark:bg-green-900/20 text-green-700 dark:text-green-400" : "bg-red-50 dark:bg-red-900/20 text-red-700 dark:text-red-400"}`}>
                {message}
              </div>
            )}
          ...
          <p className="text-center text-sm text-gray-600 dark:text-gray-400 mt-5 lg:hidden">
            ...
            <Link to="/login" className="font-semibold text-teal-600 dark:text-teal-400 hover:text-teal-700 dark:hover:text-teal-300">
              Sign In
            </Link>
          </p>
        </div>
